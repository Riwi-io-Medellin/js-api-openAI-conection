...
// ---------------------------
// Promesa para simular carga asíncrona
// ---------------------------
/**
...
// ---------------------------
// Simulación de "escribiendo..." (setTimeout)
// ---------------------------
/**
...
formulario.addEventListener('submit', async (e) => {
  ...
  // Hoisting. La función se puede llamar antes de ser declarada.
  saludar();
  function saludar() {
  ...
  simularTypingIA(async () => {
    try {
      // Obtiene la respuesta de la IA (llamada a la API).
      const respuesta = await obtenerRespuestaIA(texto);

      // Callback. `manejarRespuestaIA` se ejecuta con la respuesta.
...
// ---------------------------
// Callback para procesar la respuesta de la IA
// ---------------------------
/**
